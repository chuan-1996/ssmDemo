                        ...
                        <div class="h252 pl20 pr20">
                            ...
                            <div class="w100p">
                                <div class="h50 center">
                                    ...
                                    <input placeholder="用户名" id="username" class="itxt" type="text" name="username" autocomplete="off">
                                </div>
                            </div>
                            <div class="w100p">
                                <div class="h50 center pt10">
                                    <label for="password" class="itxt-icon"><img src=""></label>
                                    <input placeholder="真名" id="realname" class="itxt" type="password" name="realname" autocomplete="off">
                                </div>
                            </div>
                            <div class="w100p">
                                <div class="h50 center pt10">
                            ...
                            <div class="w100p">
                                <div class="h50 center">
                                    <button  class="loginBtn" type="submit" >注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;册</button>
                    ...
                    <div class="w90p">
                        <div class="login-plus h50 pt15">
                            <ul>
                                ...
                                <a href="/login" class="fr fs20 color-r" >返回登录</a>
                            </ul>
                        </div>
                    </div>
                </div>
